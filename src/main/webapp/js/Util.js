...
FN_SEND_MAIL = "sendMail";

function checkUser() {
	/*
	 * if (sessionStorage.getItem("tkn")) { //check token validity var
	 * userInfoBtn = document.getElementById('user-info-btn');
	 * $("#user-info-btn").html(sessionStorage.getItem("fname") + ' <span
	 * class="caret"></span>'); userInfoBtn.style.visibility = 'visible';
	 * document.getElementById('unlogged-div').style.display = 'none';
	 * document.getElementById('logged-div').style.display = 'block'; } else {
	 */
